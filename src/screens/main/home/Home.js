  ...
  const data = [
    {
      ...
      description:
        "4.2 oz./yd², 52/48 airlume combed and ring-spun cotton/polyester, 32 singles, Athletic Heather and Black Heather are 90/10 airlume combed and ring-spun cotton/polyester. Retail fit, unisex sizing, shoulder taping, Tear-away label.",
    },
    {
      id: 2,
      title: "T shirts",
